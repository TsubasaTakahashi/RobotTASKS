...
namespace DETECTION
{
	...
	public:
		...
		bool DetectGrayLine(const int &Threshold, const unsigned int &SampleNumber, int &ReflectLight);	/*	灰色検知(その1)	*/
		bool DetectGrayLine2(const int &Threshold, const int &ReflectLight);							/*	灰色検知(その2)	*/
	};
}  /* namespace DETECTION	*/
