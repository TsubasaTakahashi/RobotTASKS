 ...
 * Data definitions
 *===========================================================================*/
static float ud_err_theta = 0.0F;          /* ���E�ԗւ̕��ω��]�p�x(��)�ڕW�덷���Ԓl */
static float ud_psi = 0.0F;                /* �ԑ̃s�b�`�p�x(��)���Ԓl */
static float ud_theta_lpf = 0.0F;          /* ���E�ԗւ̕��ω��]�p�x(��)���Ԓl */
static float ud_theta_ref = 0.0F;          /* ���E�ԗւ̖ڕW���ω��]�p�x(��)���Ԓl */
static float ud_thetadot_cmd_lpf = 0.0F;   /* ���E�ԗւ̖ڕW���ω��]�p���x(d��/dt)���Ԓl */
